...
public class LibroController {
	...
	public String addLibroView(Evento libro, Model model) {
	...
	@PostMapping("/libros")
	public String save(@Valid Evento libro, BindingResult result, Model model) {
		try {
	...
	public String update(@Valid Evento libro, Model model) {
		try {
			libroService.add(libro);
